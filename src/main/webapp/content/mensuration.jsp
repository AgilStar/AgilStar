                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="bras" class="form-control" name="bras">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" id="poitrine" class="form-control form-control-danger" name="poitrine">
                                                    <small class="form-control-feedback">  </small> </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                               <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" id="taille" class="form-control form-control-danger" name="taille">
                                                    <small class="form-control-feedback">  </small> </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
