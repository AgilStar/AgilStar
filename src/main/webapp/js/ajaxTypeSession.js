...
/**
 * Cette m̩thode "Ajax" affiche le XML.
 *
 * On utilise la propri̩t̩ 'responseText' de l'objet XMLHttpRequest afin
 * de r̩cup̩rer sous forme de texte le flux envoy̩ par le serveur.
 * @author Alice
 */
