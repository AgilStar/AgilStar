...
function insertSession()
{
    ...
    for (var i = 0; i <= arrayLignes; i++) {
        ...
        if(arrayLignes==0){
            errorFlag = true;
            errorMessage = errorMessage + "Il faut cr�er au moins un exercice"+i+"</br>";
        }
        ...
        if (errorFlag) {
            ...
            // On insère la nouvelle s�ance dans la base de données
                ...
                if (xhr.readyState === 4 && xhr.status === 200) {
                    {
                        ...
                        if (errorMessage.length > 0) {
                            ...
                            alert("Vous avez réussi à créer une nouvelle s�ance");
                        }
